...
public class LocationController {
    ...
    @PostMapping("/test")
    public ResponseEntity<?> testTopic(){
        this.kafkaService.testTopic("Test message");
        return new ResponseEntity<>(Map.of("message", "Message sent successfully"), HttpStatus.OK);
    }
